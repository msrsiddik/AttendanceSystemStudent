...
import msr.attend.student.Messenger.model.User;
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        FireDatebase.getMessengerRef().child("Chatlist").child(new UserPreference(mContext).getStudentIdPref()).child(user.getId()).setValue(null);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                   ...
                   if (userPref.getStudentIdPref() != null && chat != null) {
                        if (chat.getReceiver().equals(userPref.getStudentIdPref()) && chat.getSender().equals(userid) ||
                                chat.getReceiver().equals(userid) && chat.getSender().equals(userPref.getStudentIdPref())) {
